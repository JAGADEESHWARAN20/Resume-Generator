...
conn.commit()
messagebox.showinfo("Success", "Committed Data Refreshed Successfully!")
conn.close()
...
def student_list():
    ...
    for student in students:
        table.insert('', 'end', values=(student[0], student[2], student[3],student[1]), tags=('button'))
